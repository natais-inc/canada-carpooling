...
import {
  Receipt, Building2, Sparkles, TrendingUp, Info, ArrowLeft, Crown,
} from 'lucide-react';
import type { BillingOverview, BillingMonthStatus } from '@/lib/billing';
...
export default function BillingView({ data, locale }: { data: BillingOverview; locale: string }) {
  ...
  const { company, trial, nextInvoice, currentMonth, history, enterpriseSuggested } = data;
